...
'''
class Setting_Separate_Train_Test:

    setting_name = None
    setting_description = None

    # trainset and testset are Dataset_Loader objects
    trainset = None
    testset = None
    method = None
    result = None
    ...
    def print_setup_summary(self):
        print('trainset:', self.trainset.dataset_name, ', testset:', self.testset.dataset_name, 'method:',
    ...
    def load_run_save_evaluate(self):
        ...
        loaded_train = self.trainset.load()
