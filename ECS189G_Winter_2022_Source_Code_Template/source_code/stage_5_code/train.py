...
from source_code.stage_6_code.utils import accuracy, precision, recall, f1_score
from source_code.stage_6_code.models import GCN
...
def plot_learning_curves(train_losses, val_losses):
    plt.plot([i for i in range(train_losses)], val_losses)
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
